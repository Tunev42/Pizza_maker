        ...
        if drinks_171 == "да":
            ...
            try:
                while fl:
                    ...
                    while fl:
                        if drinks_17w == "сок":
                            order.append(drinks_17w)
                            break
                        elif drinks_17w == "вода":
                            order.append(drinks_17w)
                            break
                        elif drinks_17w == "минеральная вода":
                            order.append(drinks_17w)
                            break
                        elif drinks_17w == "чай":
                            order.append(drinks_17w)
                            break
                        print("Вы хотите ещё напитки?")
                        yesorno = input()
                        if yesorno == "нет":
                            fl = False
                        elif yesorno == "да":
...
while True:
    ...
    if yes_no == "да":
        ...
        print("Вы хотите что то удалить или добавить?(выберите продукт по счёту начиная от 0)")
        delsoradd = input()
